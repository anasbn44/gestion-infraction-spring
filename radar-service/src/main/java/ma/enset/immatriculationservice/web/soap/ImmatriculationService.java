...
public interface ImmatriculationService {
    ...
    @WebMethod
    @RequestWrapper(localName = "getProprietaireOfVehicule", targetNamespace = "http://soap.web.immatriculationservice.enset.ma/", className = "ma.enset.immatriculationservice.web.soap.GetProprietaireOfVehicule")
    @ResponseWrapper(localName = "getProprietaireOfVehiculeResponse", targetNamespace = "http://soap.web.immatriculationservice.enset.ma/", className = "ma.enset.immatriculationservice.web.soap.GetProprietaireOfVehiculeResponse")
    @WebResult(name = "return", targetNamespace = "")
    public ma.enset.immatriculationservice.web.soap.ProprietaireResponseDto getProprietaireOfVehicule(
    ...
    @WebResult(name = "return", targetNamespace = "")
    public java.util.List<ma.enset.immatriculationservice.web.soap.VehiculeResponseDto> vehiculeList()
;
}
